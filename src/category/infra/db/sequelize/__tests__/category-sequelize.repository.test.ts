...
describe("CategorySequelizeRepository Integration Test", () => {
  ...
  test("should insert a new category", async () => {
    ...
    expect(model.toJSON()).toMatchObject(<CategoryModel>{
  ...
  test("should bulk insert a new categories", async () => {
  ...
  test("should finds a entity by id", async () => {
    ...
    entityFound.changeDate(entity.created_at) // por algum motivo, no banco o valor está sendo salvo errado, possilvelmente algum problema com timezone ou alguma coisa do sqlite
  ...
  test("should return all categories", async () => {
    ...
    entities[0].changeDate(entity.created_at) // problema com data
  ...
  test("should update a entity", async () => {
    ...
    entityFound.changeDate(entity.created_at)
    expect(entity.toJSON()).toStrictEqual(entityFound.toJSON())
  })

  test("should bulk update categories", async () => {
    const categories = Category.fake().theCategories(3).build()
    await repository.bulkInsert(categories)
